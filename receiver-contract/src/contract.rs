...
use crate::msg::{
    AccountInfo, AccountResponse, AcknowledgementMsg, DispatchResponse,
    InstantiateMsg, ListAccountsResponse, PacketMsg, QueryMsg, ReflectExecuteMsg, WhoAmIResponse, self,
};
...
mod tests {
    ...
    use cosmwasm_std::{attr, coin, from_slice, BankMsg, OwnedDeps, WasmMsg};
