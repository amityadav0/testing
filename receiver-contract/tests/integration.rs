...
use cosmwasm_std::{
    attr, ContractResult, CosmosMsg, Event, IbcBasicResponse, IbcOrder,
...
use receive_message::contract::{IBC_APP_VERSION, RECEIVE_DISPATCH_ID};
use receive_message::msg::{
    AccountInfo, AccountResponse, AcknowledgementMsg, DispatchResponse, InstantiateMsg,
    ListAccountsResponse, PacketMsg, QueryMsg,
};

// This line will test the output of cargo wasm
static WASM: &[u8] = include_bytes!("../target/wasm32-unknown-unknown/release/receive_message.wasm");
...
fn handle_dispatch_packet() {
    ...
    let msgs_to_dispatch ="Hello World".to_string();
