...
use send_message::ibc::IBC_APP_VERSION;
use send_message::ibc_msg::{AcknowledgementMsg, PacketMsg, WhoAmIResponse};
use send_message::msg::{AccountResponse, AdminResponse, ExecuteMsg, InstantiateMsg, QueryMsg};

// This line will test the output of cargo wasm
static WASM: &[u8] =
    include_bytes!("../target/wasm32-unknown-unknown/release/send_message.wasm");
